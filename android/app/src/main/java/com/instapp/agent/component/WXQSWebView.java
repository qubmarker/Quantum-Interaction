...
public class WXQSWebView implements IQSWebView {
	...
	public WXQSWebView(Context context) {
		mContext = context;
	}
	...
	private void initWebView(WebView wv) {
		...
		wv.addJavascriptInterface(this, "qswebview");
	...
	public void actionFromJsWithParam(final String str) {
		...
		try {
			...
			getParent().getInstance().fireGlobalEventCallback(data.getString("eventName"), (Map)data);
	...
	public void weexCallJsHandler(String params){
		...
		mWebView.loadUrl("javascript:weexCallJsHandler('"+params+"')");
	}
}
