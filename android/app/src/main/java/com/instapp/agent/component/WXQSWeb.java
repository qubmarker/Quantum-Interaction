...
public class WXQSWeb extends WXComponent {
	public static final String GO_BACK = "goBack";
	public static final String GO_FORWARD = "goForward";
	public static final String RELOAD = "reload";
	protected IQSWebView mWebView;

	@Deprecated
	public WXQSWeb(WXSDKInstance instance, WXDomObject dom, WXVContainer parent, String instanceId, boolean isLazy) {
		this(instance,dom,parent,isLazy);
	}

	public WXQSWeb(WXSDKInstance instance, WXDomObject dom, WXVContainer parent, boolean isLazy) {
		super(instance, dom, parent, isLazy);
		createWebView();
	}

	protected void  createWebView(){
		mWebView = new WXQSWebView(getContext());
		mWebView.setParent(this);
	}

	@Override
	protected View initComponentHostView(@NonNull Context context) {
		mWebView.setOnErrorListener(new IQSWebView.OnErrorListener() {
			@Override
			public void onError(String type, Object message) {
				fireEvent(type, message);
			}
		});
		mWebView.setOnPageListener(new IQSWebView.OnPageListener() {
			@Override
	...
	public void weexCallJsHandler(String params){
		...
		getWebView().weexCallJsHandler(params);
	}

	private IQSWebView getWebView() {
		return mWebView;
	}
}
