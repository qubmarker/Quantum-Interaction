...
//公式-----------------HX    =  ZH
			...
			var  formula_word_zimu_obj={
				...
				,"C":"<div class='quantumf' style='width: 5vw; height: 10vh; background: url(&quot;../images/square/3.png&quot;) 0% 0% / 5vw 10vh no-repeat;'>"
						...
						success:function(data){
							...
							if(data.status==200&&data.data){
								if(level==0){
									...
									qsstartGame(JSON.parse(data.data.content));
									else
									 startGame();
								}
